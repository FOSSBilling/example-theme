const FOSSBilling = {
     ...
     * Redirect to a URL.
     * 
     * @param {string} url URL to redirect to. If not provided, reload the page.
     * @returns {void}
     * @example FOSSBilling.redirect('https://fossbilling.org');
     * @example FOSSBilling.redirect(); // Reloads the page
     */
     ...
     * @param {string} type
     * @returns {void}
     * @example FOSSBilling.message('Hello world', 'info'); 
     */
